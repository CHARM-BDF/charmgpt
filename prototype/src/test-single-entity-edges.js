const query = {
  message: {
    query_graph: {
      nodes: {
        ...
        n1: {
          categories: ['biolink:NamedThing']  // Very broad category
        }
      },
      edges: {
        e0: {
  ...
  submitter: 'Single Entity Edges Test',
...
console.log('🧬 Testing single entity query with EDGES structure...');
console.log('📝 Query: What does NCBIGene:283635 connect to (using edges)');
