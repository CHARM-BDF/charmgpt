...
/**
 * Script to summarize ARS query results v3
 */
...
function summarizeResults(filename) {
  try {
    ...
    console.log('🧬 ARS Query Results Summary v3');
    ...
    console.log(`   Target Categories: ${queryGraph.nodes.n1.categories.length} specified`);
...
if (fs.existsSync('merged_results_v3.json')) {
  console.log('📁 Analyzing: merged_results_v3.json\n');
  summarizeResults('merged_results_v3.json');
} else {
  console.log('❌ No merged results v3 file found');
  console.log('Run the test script first: node test_ars_query_v3.js');
}
