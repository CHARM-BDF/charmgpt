 ...
 * Tests querying information about gene NCBIGene:283635 (FAM177A1) with updated query format
 */
...
// Updated test query for gene NCBIGene:283635 (FAM177A1)
const testQuery = {
  "message": {
    "query_graph": {
      "edges": {
...
async function submitQuery() {
  console.log('🧬 Testing ARS Query for NCBIGene:283635 (FAM177A1)');
...
async function getDetailedResults(pk) {
  ...
  try {
    ...
    if (response.statusCode === 200) {
      ...
      const resultsFile = path.join(__dirname, `ars_results_v2_${pk}.json`);
...
async function runTest() {
  console.log('🚀 Starting ARS API Test v2');
