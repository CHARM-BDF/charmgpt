describe('Charm-MCP Plotting a sine wave ', () => {
    beforeEach( function() {
    ...
    it('should be able to interact with the chat input', () => {
      ...
      const testMessage = 'Plot a sine wave using my python mcp.'
